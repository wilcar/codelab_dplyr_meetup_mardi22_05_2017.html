...
names(missing_years_natinimp)[2] = "natinimp"  
...
flags_na_natinimp_stacked  <- ggplot (missing_years_natinimp, aes(x=yearam, y=n, width = 0.5))  
flags_na_natinimp_stacked +
  geom_bar(stat="identity", aes(fill = (natinimp))) +
  scale_x_continuous(breaks=seq(1500, 1860, by=25)) +
  theme_bw() +
  ggtitle ("rattachements juridiques des navires négriers inconnu") 
