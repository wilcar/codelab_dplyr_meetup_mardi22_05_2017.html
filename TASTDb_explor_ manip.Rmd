...
Dplyr fait appel à la fonction *arrange*. L'argument par défaut est un classement par ordre croissant. Pour un classement par ordre décroissant, l'utilisation de l'argument *desc"est recquise.

```{r eval=FALSE}

# Classement des expéditions en fonction de l'année de débarquement des esclaves
datachrono <- voyages %>%
                arrange (yearam)
