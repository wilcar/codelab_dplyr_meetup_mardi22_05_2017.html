...
Les *Integer* ou *numeric*  sont des objets particuliers de **R** pour stocker des variables numeriques. Un caractère est dit quantitatif si ses modalités sont mesurables. Le caractère quantitatif prend alors le nom de *variable statistique* et ses différentes modalités sont les *valeurs* possibles de la variable (Py, 1996).
...
Pour poursuivre,il s'avère utile de pouvoir construire un tableau statistique des effectifs et fréquences des valeurs manquantes *variable par variable*.
