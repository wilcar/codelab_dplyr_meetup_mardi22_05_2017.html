...
Dplyr fait appel à la fonction *arrange*. L'argument par défaut est un classement par ordre croissant. Pour un classement par ordre décroissant, l'utilisation de l'argument *desc"t recquise.
...
L'omission, des données manquante s'effectue à la l'aide la fonction complete.cases {stats}
```{r eval = FALSE}
