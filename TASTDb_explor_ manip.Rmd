...
* *voyageid* est un objet de type *integer*  
* *shipname* est un objet de type *Factor*  
...
sort (unique (voyages$ptdepimp)) # classement des modalités par ordre alphabétique (combinaison avec la fonction sort)
